...
@androidx.wear.tiles.tooling.preview.Preview(name = "Small round - Small Font", group = "Small Font", device = WearDevices.SMALL_ROUND, fontScale = 0.85f)
@androidx.wear.tiles.tooling.preview.Preview(name = "Small round - Regular Font", group = "Regular Font", device = WearDevices.SMALL_ROUND, fontScale = 1.0f)
@androidx.wear.tiles.tooling.preview.Preview(name = "Small round - Large Font", group = "Large Font", device = WearDevices.SMALL_ROUND, fontScale = 1.15f)
@androidx.wear.tiles.tooling.preview.Preview(name = "Small round - XLarge Font", group = "Extra Large Font", device = WearDevices.SMALL_ROUND, fontScale = 1.3f)
@androidx.wear.tiles.tooling.preview.Preview(name = "Large round", device = WearDevices.LARGE_ROUND, group = "Large Round")
@androidx.wear.tiles.tooling.preview.Preview(name = "Square", device = WearDevices.SQUARE, group = "Square")
@androidx.wear.tiles.tooling.preview.Preview(name = "Rectangle", device = WearDevices.RECT, group = "Rectangle")
